          ...
          child: Column(
            ...
            children: [
              ...
              CharoTile(
                ...
                title: 'Новый чат',
                onTap: () { Navigator.pop(ctx); context.go('/create-chat', extra: {'chatType': 'private'}); },
              ),
              CharoTile(
                icon: Icons.group_add_outlined,
                iconColor: const Color(0xFF10B981),
                title: 'Новая группа',
                onTap: () { Navigator.pop(ctx); context.go('/create-chat', extra: {'chatType': 'group'}); },
              ),
              CharoTile(
                icon: Icons.campaign_outlined,
                iconColor: const Color(0xFF3B82F6),
                title: 'Новый канал',
                onTap: () { Navigator.pop(ctx); context.go('/create-chat', extra: {'chatType': 'channel'}); },
              ),
              CharoTile(
                icon: Icons.enhanced_encryption,
                iconColor: const Color(0xFF8B5CF6),
                title: 'Секретный чат',
                onTap: () { Navigator.pop(ctx); context.go('/create-chat', extra: {'chatType': 'secret'}); },
              ),
            ],
          ),
        ),
